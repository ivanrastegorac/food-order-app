...
const Checkout = (props) => {
  ...
  const nameControledClasses = `${classes.control} ${
    formInputsValidity.name ? '' : classes.invalid
  }`;

  const streetControledClasses = `${classes.control} ${
    formInputsValidity.street ? '' : classes.invalid
  }`;

  const postalCodeControledClasses = `${classes.control} ${
    formInputsValidity.name ? '' : classes.invalid
  }`;

  const cityControledClasses = `${classes.control} ${
    formInputsValidity.name ? '' : classes.invalid
  }`;
